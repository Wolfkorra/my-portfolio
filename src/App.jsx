...
function AppContent() {
  ...
  return (
    <div className="App">
      ...
      {!isProjectPage && <Navbar theme={theme} toggleTheme={toggleTheme} />}
      ...
      {/* Floating Theme Toggle for Project Pages */}
      {isProjectPage && (
        <button 
          onClick={toggleTheme} 
      ...
      <footer className="footer">
        <div className="page-columns footer-content">
          <span>© 2026 Abdullah Korra</span>
