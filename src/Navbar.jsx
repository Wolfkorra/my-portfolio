...
export default function Navbar({ theme, toggleTheme }) {
  ...
  return (
    <nav className="navbar">
      <div className="navbar-container container-fluid d-flex justify-content-between align-items-center w-100 page-columns">
        <div className="navbar-brand-container">
          <Link className="navbar-brand" to="/#home">abdullah.</Link>
        </div>
        <div className="navbar-collapse" id="navbarCollapse">
          <ul className="navbar-nav">
            ...
            <li className="nav-item" style={{ display: 'flex', alignItems: 'center', marginLeft: '0.5rem' }}>
              <button 
                onClick={toggleTheme} 
